...
class _BolroomDmScreenState extends State<BolroomDmScreen> {
  ...
  void initState() {
    ...
    _loadConvos();
    _sb
        .channel('bolroom_dm_list')
        .onPostgresChanges(
          event: PostgresChangeEvent.all,
          schema: 'public',
          table: 'bolroom_dm_conversations',
  ...
  void dispose() {
    try {
      _sb.removeChannel(_sb.channel('bolroom_dm_list'));
    } catch (_) {}
    super.dispose();
  }
  ...
  String _otherUserId(Map<String, dynamic> c) =>
      c['user1_id'] == _myId ? c['user2_id'] : c['user1_id'];
  ...
  void _openChat(Map<String, dynamic> convo, String otherName,
      {String? avatarKey, String? customUrl}) async {
    HapticFeedback.lightImpact();
    await Navigator.push(
        context,
        BolroomTheme.slideRoute(BolroomDmChatScreen(
          conversationId: convo['id'].toString(),
          partnerId: _otherUserId(convo),
          partnerName: otherName,
          partnerAvatarKey:
              avatarKey ?? BolroomAvatars.forUser(_otherUserId(convo)).id,
          partnerAvatarUrl: customUrl,
        )));
    _loadConvos();
  }
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: Text('Pin chat',
                      style: doodle
                          ? DoodleFonts.body(color: DoodleColors.brown)
                ...
                ListTile(
                  ...
                  title: Text('Delete chat',
                      style: doodle
                          ? DoodleFonts.body(color: const Color(0xFFEF4444))
        ...
        builder: (ctx) => AlertDialog(
              ...
              title: Text('Delete chat with $name?',
                  style: doodle
                      ...
                      : const TextStyle(color: Colors.white)),
              content: Text('This will delete the chat only for you.',
                  style: doodle
                      ? DoodleFonts.body(
              ...
              actions: [
                ...
                TextButton(
                  ...
                  child: Text('Delete',
                      style: doodle
                          ? DoodleFonts.body(
                                  color: const Color(0xFFEF4444), fontSize: 14)
            ...
            : Column(
                ...
                children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content:
                                    Text('Message Requests coming soon!')));
                      },
                      child: Container(
                  ...
                  if (searchQuery.isEmpty && _convos.isNotEmpty) ...[
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 20, top: 4, bottom: 8),
                    ...
                    child: _convos.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return _buildDynamicChatTile(
                                  _convos[index], index, doodle);
                            },
                          ),
                  ),
                ],
        ...
        children: _convos.take(5).toList().asMap().entries.map((entry) {
          ...
          return FutureBuilder<Map<String, dynamic>?>(
              future: _sb
                  ...
                  .select(
                      'anon_name, aura_color, avatar_key, custom_avatar_url')
                  .eq('id', otherId)
                  .maybeSingle(),
              builder: (_, snap) {
                final p = snap.data;
                ...
                try {
                  aura = Color(int.parse('FF${auraHex.replaceFirst('#', '')}',
                      radix: 16));
                } catch (_) {}
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () => _openChat(c, name,
                        ...
                        customUrl: p?['custom_avatar_url']?.toString()),
                    child: Column(
                      children: [
                        doodle
                            ? CircleAvatar(
                                ...
                                child: Icon(Icons.person,
                                    color: DoodleColors.cream, size: 30))
                            : BolroomAvatarWidget(
                                size: 60,
                                avatarUrl: p?['custom_avatar_url']?.toString(),
                                avatarKey: p?['avatar_key']?.toString(),
                                userId: otherId,
                                showRing: true,
                                isOnline: true,
  ...
  Widget _buildDynamicChatTile(
      Map<String, dynamic> chat, int idx, bool doodle) {
    final otherId = _otherUserId(chat);
    return FutureBuilder<Map<String, dynamic>?>(
        future: _sb
            .from('bolroom_profiles')
            .select('anon_name, aura_color, avatar_key, custom_avatar_url')
            .eq('id', otherId)
            .maybeSingle(),
        builder: (_, snap) {
          final p = snap.data;
          ...
          try {
            aura = Color(
                int.parse('FF${auraHex.replaceFirst('#', '')}', radix: 16));
          } catch (_) {}
          ...
          final partnerCustomUrl = p?['custom_avatar_url']?.toString();
          ...
          return Dismissible(
            ...
            child: InkWell(
              onTap: () => _openChat(chat, name,
                  avatarKey: partnerAvatarKey, customUrl: partnerCustomUrl),
              ...
              child: Container(
                ...
                decoration: doodle
                    ? BoxDecoration(
                        color:
                            hasUnread ? DoodleColors.paper : Colors.transparent,
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
                            color: hasUnread
                                ? DoodleColors.brown
                    ...
                    : BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(16),
                        border:
                            hasUnread ? Border.all(color: borderColor) : null,
                      ),
                child: Row(
                  children: [
                    Stack(
                      children: [
                        doodle
                            ? CircleAvatar(
                                ...
                                radius: 25,
                                child: Icon(Icons.person,
                                    color: DoodleColors.cream, size: 25))
                            : BolroomAvatarWidget(
                                size: 50,
                                avatarUrl: partnerCustomUrl,
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: doodle
                                ...
                                : TextStyle(
                                    color:
                                        hasUnread ? Colors.white70 : textMuted,
                                    fontSize: 13,
                                  ),
                          ),
                        ],
                          ...
                          Container(
                            ...
                            decoration: doodle
                                ? BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(10),
                                    border:
                                        Border.all(color: DoodleColors.brown),
                                  )
                                : BoxDecoration(
          ...
          Container(
            ...
            decoration: doodle
                ...
                : BoxDecoration(
                    ...
                    color: cardColor,
                    border: Border.all(
                        color: Color(0xFFFF6B00).withValues(alpha: 0.15))),
            child: Icon(Icons.send_rounded,
                size: 40,
                color: doodle ? DoodleColors.blue : Color(0xFFFF6B00)),
          ),
          SizedBox(height: 18),
          Text('No messages yet',
              style: doodle
                  ? DoodleFonts.heading(color: DoodleColors.brown, fontSize: 24)
                  : TextStyle(
                      color: Colors.white,
                      fontSize: 18,
                      fontWeight: FontWeight.bold)),
          SizedBox(height: 6),
          Text('Start a conversation anonymously',
              style: doodle
                  ? DoodleFonts.body(
                      color: DoodleColors.brown.withValues(alpha: 0.6),
                      fontSize: 14)
            ...
            Container(
              decoration: doodle
                  ? DoodleDecorations.input()
                      .copyWith(color: DoodleColors.cream)
                  : BoxDecoration(
                      color: cardColor,
                ...
                child: ctrl.text.trim().length < 2
                    ...
                    : FutureBuilder<List<dynamic>>(
                        future: _sb
                            .from('bolroom_profiles')
                            .select(
                                'id, anon_name, avatar_key, custom_avatar_url, aura_color')
                            .ilike('anon_name', '%${ctrl.text.trim()}%')
                            .neq('id', _myId)
                            .limit(20),
                        builder: (_, snap) {
                          if (!snap.hasData)
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              Color aura = purpleDark;
                              try {
                                aura = Color(int.parse(
                                    'FF${auraHex.replaceFirst('#', '')}',
                                    radix: 16));
                              } catch (_) {}
