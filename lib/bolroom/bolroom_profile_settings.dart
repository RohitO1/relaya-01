...
class BolroomSettingsGrid extends StatelessWidget {
  ...
  const BolroomSettingsGrid({
    ...
    required this.voiceModulator,
    required this.auraColor,
    required this.hideOnline,
    required this.followerCount,
    required this.followingCount,
    required this.onAvatarChanged,
    required this.onModulatorChanged,
    required this.onAuraChanged,
    required this.onHideOnlineChanged,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(children: [
        // Row 1: Avatar + (Empty Space to preserve grid)
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Expanded(
              child: _AvatarCard(
                  avatarKey: avatarKey, onChanged: onAvatarChanged)),
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Expanded(
              child: _AuraColorCard(
                  auraColor: auraColor, onChanged: onAuraChanged)),
          SizedBox(width: 12),
          Expanded(
              child: _PrivacyCard(
                  hideOnline: hideOnline, onChanged: onHideOnlineChanged)),
        ]),
        SizedBox(height: 12),
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Expanded(
              child: _FollowCard(
                  title: 'Followers',
                  count: followerCount,
                  onViewAll: onViewFollowers)),
          SizedBox(width: 12),
          Expanded(
              child: _FollowCard(
                  title: 'Following',
                  count: followingCount,
                  onViewAll: onViewFollowing)),
        ]),
      ]),
    );
  }
            ...
            return GestureDetector(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: doodle
                        ...
                        : (e.value['color'] as Color)
                            .withValues(alpha: sel ? 0.35 : 0.12),
                    border: Border.all(
                        color: sel
                            ? (doodle
                                ? DoodleColors.orange
                ...
                Text(e.value['label'] as String,
                    style: doodle
                        ? DoodleFonts.body(
                                color: DoodleColors.brown, fontSize: 9)
                            .copyWith(fontWeight: FontWeight.bold)
                        : GoogleFonts.inter(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Center(
          ...
          child: Stack(alignment: Alignment.center, children: [
            // Color wheel ring
            CustomPaint(
                painter: _ColorWheelPainter(doodle: doodle),
                size: Size(90, 90)),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: doodle && auraColor == '#7856FF'
                    ? DoodleColors.orange
                    : _parseHex(auraColor), // Default doodle aura
                boxShadow: [
                  BoxShadow(
                      color: (doodle && auraColor == '#7856FF'
                              ? DoodleColors.orange
        ...
        Row(
            ...
            children: ['#7856FF', '#E8457A', '#00D4B8', '#FFB347', '#4E8BFF']
                .map((hex) {
              final sel = auraColor == hex;
              final c = doodle && hex == '#7856FF'
                  ? DoodleColors.orange
                  : _parseHex(hex);
              return GestureDetector(
                onTap: () {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: sel
                            ? (doodle ? DoodleColors.brown : Colors.white)
                            : Colors.transparent,
                        width: 2),
                  ),
                ),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Icon(Icons.lock_outline,
              color: doodle ? DoodleColors.brown : BolroomTheme.gold, size: 16),
          SizedBox(width: 6),
          Text('Privacy Vault',
              style: doodle
                  ? DoodleFonts.body(color: DoodleColors.brown, fontSize: 14)
        ...
        Row(children: [
                ...
                Text('Hide online status',
                    style: doodle
                        ...
                        : GoogleFonts.inter(
                            ...
                            fontWeight: FontWeight.w600)),
                SizedBox(height: 2),
                Text('You will appear offline to others',
                    style: doodle
                        ? DoodleFonts.body(
          ...
          SizedBox(
            ...
            child: Switch(
              ...
              onChanged: onChanged,
              activeThumbColor:
                  doodle ? DoodleColors.cream : BolroomTheme.purple,
              activeTrackColor: doodle
                  ? DoodleColors.blue
                  : BolroomTheme.purple.withValues(alpha: 0.4),
              inactiveThumbColor: doodle ? DoodleColors.brown : null,
              inactiveTrackColor: doodle ? DoodleColors.paper : null,
              trackOutlineColor:
                  doodle ? WidgetStateProperty.all(DoodleColors.brown) : null,
            ),
          ),
        ]),
      ]),
...
class _FollowCard extends StatelessWidget {
  ...
  const _FollowCard(
      {required this.title, required this.count, required this.onViewAll});
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Container(
                      ...
                      decoration: doodle
                          ...
                          : BoxDecoration(
                              shape: BoxShape.circle,
                              color:
                                  BolroomTheme.purple.withValues(alpha: 0.12)),
                      child: Center(
                          child:
                              Text(icons[i], style: TextStyle(fontSize: 14))),
                    ),
                    SizedBox(width: 8),
                    Expanded(
                        child: Column(
        ...
        GestureDetector(
          onTap: onViewAll,
          child: Row(children: [
            Text('View all ${title.toLowerCase()}',
                style: doodle
            ...
            Icon(Icons.arrow_forward,
                color: doodle ? DoodleColors.blue : BolroomTheme.purple,
                size: 14),
          ]),
        ),
      ]),
