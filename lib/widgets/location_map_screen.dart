...
class LocationMapScreen extends StatefulWidget {
  ...
  const LocationMapScreen(
      {super.key, required this.lat, required this.lng, required this.title});
...
class _LocationMapScreenState extends State<LocationMapScreen> {
  ...
  List<LatLng> _decodePolyline(String encoded) {
    ...
    debugPrint(
        '[Route] decoded ${poly.length} points from ${encoded.length}-char geometry');
    return poly;
  }
          ...
          child: Column(children: [
            Row(children: [
              Expanded(
                ...
                label: 'Distance',
                value: _myLocation == null ? '—' : _formatDist(_distanceMeters),
              )),
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      if (_myLocation != null)
                        _fitBothLocations(_myLocation!, eventPoint);
                    },
                    child: const Text('Show full route',
                        style: TextStyle(
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: _isLoadingRoute
                    ...
                    : Icon(_isNavigating ? Icons.navigation : Icons.directions,
                ...
                onPressed: (_isLoadingRoute || _myLocation == null)
                    ? null
                    : () {
                        if (!_isNavigating) {
                          _fetchRoute();
